...
/**
 * check97 - check if the number of argument is correct
...
/**
 * check98 - check if the file_from exists and can be read
 * check: check if true of false
 * file: file_from name
 * fd_from:the file descriptor of the file_from, or -1
...
/**
 * check99 - check if the file_to was created and/or can be written to
 * check: check if true of false
 * file: file_to name
...
/**
 * check100 - check if the file descriptors were closed properly
